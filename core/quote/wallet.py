...
#: DEFENSIVE HARDENING, INERT TODAY: as of 2026-09-02 production holds
#: 15,254,061 book_levels rows, all stamped, ZERO NULL captured_at — so this
#: branch fires on nothing now. It exists because a silent drop of imported
#: fetched-together rows would read as a thin book, which is P&L-FLATTERING on a
#: losing book (silent AND biased); inert-and-self-reporting beats that.
