...
| [public-wp-models.md](math/public-wp-models.md) | Why public win-probability models (nflfastR, CFBD) work, and what happens on our tape (DESCRIPTIVE — λ* = −0.022 [−0.443, +0.400]; the model adds nothing beyond the mid) |
