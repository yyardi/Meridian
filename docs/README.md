...
| [q4-endgame-state.md](math/q4-endgame-state.md) | Does Q4 endgame state (possession, bonus, timeouts) improve win-probability calibration? (REGISTERED 2026-08-25, nothing computed) |
